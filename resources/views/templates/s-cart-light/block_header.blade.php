              ...
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item">
                      <a class="rd-nav-link" {{ ($url['data']['target'] =='_blank')?'target=_blank':''  }} href="{{ sc_url_render($url['data']['url']) }}">{{ sc_language_render($url['data']['name']) }}</a>
                    </li>
                    @else
                    ...
                    <li class="rd-nav-item"><a class="rd-nav-link" href="#"><i class="fa fa-lock"></i> {{ sc_language_render('front.account') }}</a>
                      <ul class="rd-menu rd-navbar-dropdown">
                        ...
                        <span class="count sc-compare" id="shopping-compare">{{ Cart::instance('compare')->count() }}</span>
                        </a>
                    </li> --}}
                  </ul>
                  </li>
                ...
                <div class="rd-navbar-main-element">
                  ...
                  <div class="rd-navbar-search rd-navbar-search-2">
                    <button class="rd-navbar-search-toggle rd-navbar-fixed-element-3" data-rd-navbar-toggle=".rd-navbar-search"><i class="fa fa-search fa-lg"></i></button>
                  ...
                  <div class="rd-navbar-basket-wrap">
                    <a href="{{ sc_route('cart') }}">
                      <button class="rd-navbar-basket">
                        <i class="fa fa-shopping-cart"></i>
                        <span class="count sc-cart" id="shopping-cart">{{ Cart::instance('default')->count() }}</span>
                      </button>
                    </a>
                  </div>
                  <a title="{{ sc_language_render('cart.page_title') }}" style="margin-top:10px;" class="rd-navbar-basket rd-navbar-basket-mobile fa fa-shopping-cart rd-navbar-fixed-element-2" href="{{ sc_route('cart') }}">
