...
@include($sc_templatePath . '.common.modal')
...
<script>
    ...
    function openBootstrapModal(modalId = '#appModalLong') {
        const bootstrapModal = $(modalId);

        bootstrapModal.find('.modal-body').html(bootstrapModalOptions.content);
        bootstrapModal.find('.modal-title').html(bootstrapModalOptions.title);
        if (bootstrapModalOptions.hideConfirm) {
            $(modalId + 'ConfirmButton').hide();
        }
